...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	try
	{
		...
		int chs = 0;
		cout << "1 - Enter name of server" << endl << "2 - Nick" << endl << "> ";
		cin >> chs;
		if (chs == 1)
		{
		...
		while (!fin)
		{
			cout << "Choose: " << endl << "1 - Rand" << endl << "2 - Time" << endl << "3 - Echo" << endl << "> ";
			cin >> cCall;
		...
		case 1:
			strcpy(Call, "Rand");
			cout << "Enter Rand or other command for exit:" << endl;
			break;
		case 2:
			strcpy(Call, "Time");
			cout << "Enter Time or other command for exit:" << endl;
			break;
		case 3:
			strcpy(Call, "Echo");
			cout << "Enter string to sending messageor exit for closing:" << endl;
			break;
		default:
			strcpy(Call, "Echo");
		}
		...
		else
		{
			...
			while (!fin)
			{
				...
				else
				{
					...
					{
						printf("Server end connection: %s\n", obuf);
						break;
					}
					else
